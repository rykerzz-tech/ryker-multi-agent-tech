/**
 * ryker-multi-agent-tech run-from-file <path> — Run agent from markdown file with frontmatter
 *
 * Frontmatter spec:
 *   ---
...
async function runFromFile(filePathArg, options = {}) {
  ...
  if (!filePathArg) {
    console.log(chalk.red("Usage: ryker-multi-agent-tech run-from-file <path-to-markdown>\n"));
    return;
  }
