...
async function cmdUpdate(options) {
  ...
  if (!fs.existsSync(targetAgent) && !fs.existsSync(targetWindsurf)) {
    console.log(chalk.yellow(".agent/ or .windsurf/ not found. Run `ryker-multi-agent-tech init` first.\n"));
    return;
  }
  ...
  if (latest && latest !== CURRENT_VERSION) {
    ...
    console.log("Run: npx ryker-multi-agent-tech@latest update\n");
    return;
  }
