...
const SKILL_PREFIX = "ryker-multi-agent-tech-skill-";
...
function install(projectDir, name) {
  ...
  const tmpDir = path.join(require("os").tmpdir(), `ryker-multi-agent-tech-skill-install-${require("crypto").randomUUID()}`);
