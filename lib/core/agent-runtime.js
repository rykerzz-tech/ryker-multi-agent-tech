...
const { buildSystemPrompt, buildGeminiSystemPrompt, truncateSkillContent, getSkillBudget, MAX_SKILL_INSTRUCTION_CHARS, MAX_SKILL_INSTRUCTION_CHARS_GEMINI } = require("./prompt-builder");
