...
function loadAgentSpec(projectDir, agentName) {
  ...
  if (!cfgDir) throw new Error("No config directory found. Run `ryker-multi-agent-tech init` first.");
  ...
  if (specConfig) {
    ...
    if (specVersion && parseInt(specVersion, 10) > 2) {
      throw new Error(`Unsupported runtime spec version: v${specVersion}. This CLI supports v1-v2. Please update ryker-multi-agent-tech.`);
    }
  }
