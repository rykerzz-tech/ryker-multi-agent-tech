...
[![Version](https://img.shields.io/badge/version-2.0.0-blue?style=for-the-badge&logo=semver&logoColor=white)](https://github.com/rykerzz-tech/ryker-multi-agent-tech/releases)
...
[![Tests](https://img.shields.io/badge/Tests-60%2F60%20Passing-00E676?style=for-the-badge&logo=githubactions&logoColor=white)](package.json)
[![Updated](https://img.shields.io/badge/Updated-2026--09--11-ff69b4?style=for-the-badge)](https://github.com/rykerzz-tech/ryker-multi-agent-tech)

<br>

```bash
# Option 1: Run & Initialize directly from npm (v2.0.0)
npx rykerzz-multi-agent init

# Option 2: Update existing installation to latest version
npx rykerzz-multi-agent update

# Option 3: Install or upgrade globally
npm install -g rykerzz-multi-agent
rykerzz-multi-agent init

# Check current version
rykerzz-multi-agent version
```
...
**Ryker Multi-Agent Tech v2.0.0 (ELITE-NEXUS v2)** is an enterprise-grade autonomous AI operating system designed for multi-agent orchestration, intelligent LLM provider failover, multi-tiered memory management, and universal IDE integration.
...
- **🧠 11-Step Cognitive Pipeline & Decomposition**: Autonomous intent routing, complexity estimation, `CognitiveDecomposer`, `SelfReflectionEngine`, and `SwarmOrchestrator`.
- **⚡ Universal Multi-LLM Failover Engine**: Zero-downtime fallback across OpenAI (GPT-4o, o1, o3-mini), Anthropic Claude (3.7 / 3.5 Sonnet), Google Gemini (2.0 / 1.5 Flash/Pro), DeepSeek (V3 / R1), Mistral, Groq, Ollama (Local), and Mock providers.
...
- **🔌 MCP Protocol Support**: Full native Model Context Protocol (MCP) server integration (stdio & SSE).
- **💻 Cross-IDE Sync**: Native compatibility with Windsurf (`.windsurfrules`), Cursor (`.cursorrules`), Claude Code (`CLAUDE.md`), and Roo Code.
