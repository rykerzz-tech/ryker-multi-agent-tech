# Ryker MultiAgent Tech Dashboard — Architecture
...
```
┌──────────────────────────┐          ┌──────────────────────────┐
│     Dashboard (Next.js)  │          │    Ryker API (Express)    │
│     Port 3001            │          │    Port 3000             │
│                          │          │                          │
│  ┌────────────────────┐  │  WS      │  ┌────────────────────┐ │
...
metrics-panel.tsx → fetch /api/metrics → API proxy route → RYKER_API_URL/metrics
api/[...path]/route.ts → RYKER_API_URL + RYKER_API_KEY (server-side proxy)
