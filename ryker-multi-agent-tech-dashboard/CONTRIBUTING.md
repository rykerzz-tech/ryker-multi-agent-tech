# Contributing to Ryker MultiAgent Tech Dashboard
...
- Node.js 18+ (or Bun)
- npm 9+
- A running Ryker API server (for integration testing)

## Setup

```bash
git clone https://github.com/rykerzz-tech/ryker-multi-agent-tech.git
cd ryker-multi-agent-tech/ryker-multi-agent-tech-dashboard
npm install
```
...
METRICS_PROXY_ALLOWED_HOSTS=ryker-api npm run dev
```
