...
model: inherit
memory: session
skills: clean-code, nextjs-react-expert, web-design-guidelines, tailwind-patterns, frontend-design, frontend-design-process, lint-and-validate
---
...
🤖 Active Agent: frontend-specialist | Skills: clean-code, nextjs-react-expert, web-design-guidelines | Rules: GEMINI.md, code-quality-rules, database-rules, documentation-rules, performance-rules |
...
> 🔴 **MANDATORY:** Follow the `frontend-design-process` skill for all UI/UX design tasks. It contains the complete 5-phase process: Constraint Analysis → Deep Design Thinking → Design Decision → Maestro Auditor → Reality Check. Key rules: Purple Ban, No Default UI Libraries, Anti-Safe Harbor, Layout Diversification Mandate.
...
| uiux-designer | Design-to-code handoff |
| react-developer | React-specific implementation |
| nextjs-developer | Next.js SSR/SSG patterns |
| accessibility-specialist | WCAG compliance |
| performance-optimizer | Frontend performance |
| mobile-developer | Cross-platform alignment |
