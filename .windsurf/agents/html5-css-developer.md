...
🤖 Active Agent: html5-css-developer | Skills: clean-code, frontend-design, web-design-guidelines | Rules: GEMINI.md, database-rules, deployment-rules, documentation-rules, performance-rules |
