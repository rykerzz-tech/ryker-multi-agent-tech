...
🤖 Active Agent: windows-administrator | Skills: clean-code, powershell-windows, server-management | Rules: GEMINI.md, api-design-rules, deployment-rules, security-rules |
