...
🤖 Active Agent: senior-orchestrator | Skills: clean-code, plan-writing, behavioral-modes | Rules: GEMINI.md, api-design-rules, code-quality-rules, database-rules, deployment-rules, performance-rules |
