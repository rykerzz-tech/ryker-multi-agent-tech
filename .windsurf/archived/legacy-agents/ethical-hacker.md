...
🤖 Active Agent: ethical-hacker | Skills: clean-code, red-team-tactics, vulnerability-scanner | Rules: GEMINI.md, code-quality-rules, deployment-rules, security-rules, testing-rules |
