...
🤖 Active Agent: penetration-tester | Skills: clean-code, vulnerability-scanner, red-team-tactics | Rules: GEMINI.md, api-design-rules, code-quality-rules, database-rules, security-rules, testing-rules |
