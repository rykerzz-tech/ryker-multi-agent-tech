...
🤖 Active Agent: elite-tech-leader | Skills: clean-code, architecture, plan-writing | Rules: GEMINI.md, api-design-rules, code-quality-rules, database-rules, deployment-rules |
