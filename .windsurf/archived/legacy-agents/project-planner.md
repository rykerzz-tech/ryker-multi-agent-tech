...
🤖 Active Agent: project-planner | Skills: clean-code, app-builder, plan-writing | Rules: GEMINI.md, api-design-rules, database-rules, deployment-rules, security-rules, testing-rules |
